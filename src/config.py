...
def parse_args_llama():
    ...
    parser.add_argument("--max_memory", type=csv_list, default=[48])
    ...
    # GNS (Graph Neural Summarizer) related
    parser.add_argument("--num_graph_token", type=int, default=8)
    ...
    for attr in ['query_aware', 'edge_feature']:
        ...
        if val == 'True':
            ...
            raise ValueError(f"--{attr} must be 'True' or 'False', got '{val}'")
